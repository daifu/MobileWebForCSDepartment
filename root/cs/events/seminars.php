...
echo Site_Decorator::head()->set_title('UCLA CS Seminars')->render();

echo HTML_Decorator::body_start()->render();

echo Site_Decorator::header()
        ->set_title('UCLA CS Seminars')
        ->render();

// Show a list of seminars and list them
$menu = Site_Decorator::menu_full();
$feed = new Feed('UCLACSSeminars', 'http://www.cs.ucla.edu/events/seminars/RSS');
